...
for (const param in params) {
  var tname = params[param]['name'];
  var tvalue = params[param]['value'];
  console.log(param+" : { name: "+tname+", value: "+tvalue+"}");
}
